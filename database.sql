...
CREATE TABLE aggregateConcreteTestResults (
	test_id serial PRIMARY KEY,
	client_id INT NOT NULL REFERENCES reg_users ON DELETE RESTRICT,
	sample_id INT UNIQUE NOT NULL REFERENCES sampleSubmission ON DELETE RESTRICT,
	sampleName VARCHAR ( 255 ) NOT NULL,
	...
	labTechnician VARCHAR ( 255 ) NOT NULL,
	massBefore VARCHAR DEFAULT NULL,
	massAfter VARCHAR DEFAULT NULL,
	sieveOpeningSize VARCHAR DEFAULT NULL,
	retainedOnEachSieve VARCHAR DEFAULT NULL,
	cumulativeMaterialMassRetained VARCHAR DEFAULT NULL,
	cumulativePercentRetained VARCHAR DEFAULT NULL,
	totalPassingSieve VARCHAR DEFAULT NULL,
	sample VARCHAR DEFAULT NULL,
	initial_dry_mass_aggregates VARCHAR DEFAULT NULL,
	mass_aggregates_retained_2_36mm_sieve VARCHAR DEFAULT NULL,
	mass_aggregates_passing_2_36mm_sieve VARCHAR DEFAULT NULL,
	mass_abrasive_charges VARCHAR DEFAULT NULL,
	aggregate_crushing_value VARCHAR DEFAULT NULL,
	mass_aggregates_retained_1_7mm_sieve VARCHAR DEFAULT NULL,
	mass_aggregates_passing_1_7mm_sieve VARCHAR DEFAULT NULL,
	steel_spheres_number VARCHAR DEFAULT NULL,
	los_angeles_value VARCHAR DEFAULT NULL,
	initial_mass VARCHAR DEFAULT NULL,
	flocculat_height_h1 VARCHAR DEFAULT NULL,
	sediment_height_h2 VARCHAR DEFAULT NULL,
	sand_equivalent_100xh2_h1 VARCHAR DEFAULT NULL,
	average VARCHAR DEFAULT NULL,
	age VARCHAR DEFAULT NULL,	
	weight VARCHAR DEFAULT NULL,	
	load_kn VARCHAR DEFAULT NULL,	
	section VARCHAR DEFAULT NULL,
	strength VARCHAR DEFAULT NULL	
);
...
dry_density,weight_pan_wet_mat,weight_pan_dry_mat,weight_dry_material,
panNo,pan_weight, water_weight, moisture_content

penetration,blowsNo,wet_density,moisture_content,dry_density,panNo,blows_56_reading,blows_56_load,blows_25_reading,
blows_25_load,blows_10_reading,blows_10_load,swell,blows_56_swell,blows_25_swell,blows_10_swell,mouldNo,mass_mould_wet_mat,
mass_mould,mass_wet_material,mould_volume,ref_proctor,percent_compaction,cbr_indice,mass_pan_wet_mat,mass_pan_dry_mat,
